...
const faqData: FAQEntry[] = [
  // General Questions
  {
    ...
    answer:
      "E Broker is a real estate membership program that allows you to learn about Dubai real estate and earn commissions by selling properties. It's an innovative real estate e-commerce platform that enables individuals worldwide to sell Dubai properties remotely.",
    category: "General",
  ...
  },
  {
    ...
    answer:
      "E Broker streamlines the process for real estate agents by offering quick registration, full access to an E-learning platform, interactive training, certification, instant job placement, and business management tools—all while earning 35% commission on successful sales.",
    category: "General",
  ...
  },
  {
    ...
    answer:
      "You get lifetime access to real estate courses, a business portal, and tools to sell Dubai properties. This includes training materials, property listings, and support services to help you succeed.",
    category: "General",
    keywords: [
      "include",
      "contain",
  ...
  },
  {
    ...
    answer:
      "Yes, E Broker is available worldwide. Our platform is designed to help property professionals from anywhere connect with Dubai's real estate market.",
    category: "General",
  ...
  },
  {
    ...
    answer:
      "To sign up, simply click the 'Sign Up' button on our website (www.e-broker.world) and fill out the form. After submitting, one of our agents will contact you to guide you through the next steps and get you started.",
    category: "General",
  ...
  },
  {
    ...
    answer:
      "We are currently working on an app for easy access. For now, our website is mobile-friendly and can be accessed from any device.",
    category: "General",
  ...
  },
  {
    ...
    answer:
      "No, E Broker is a membership platform that helps individuals sell Dubai real estate and earn commissions.",
    category: "General",
  ...
  },
  {
    ...
    answer:
      "No, the lifetime membership fee is $499, which grants you full access.",
    category: "General",
  ...
  },
  {
    ...
    answer:
      "Our office is located at: Office 21-41, Conrad Business Tower, SZR, Dubai, United Arab Emirates.",
    category: "General",
  ...
  },
  {
    ...
    answer:
      "You can reach us at: Email: info@blac-co.com or Phone: +971 58 520 9417",
    category: "General",
  ...
  },
  {
    ...
    answer:
      "Anyone can become an E Broker member! Whether you're a real estate broker, student, fresh graduate, or career professional, our platform is designed to empower individuals to succeed in Dubai's real estate market remotely.",
    category: "General",
  ...
  // E-Learning & Training
  {
    ...
    answer:
      "Our courses cover Dubai real estate laws, sales techniques, marketing strategies, and property investment.",
    category: "Training",
  ...
  },
  {
    ...
    answer:
      "Yes, you get a certification upon completion. When you join E Broker, you can earn certifications recognized by the Dubai Land Department (DLD) & Knowledge and Human Development Authority (KHDA), which can help you stand out in the real estate industry.",
    category: "Training",
    keywords: [
      "certificate",
      "certification",
  ...
  },
  {
    ...
    answer:
      "After joining, you'll receive a login link with your username and password.",
    category: "Training",
  ...
  // Selling & Commissions
  {
    ...
    answer:
      "E Broker offers a generous 35% commission per successful sale, with fast payouts within 3-4 working days. The more deals you close, the more you earn!",
  ...
  },
  {
    ...
    answer:
      "You list properties on our platform, generate leads, and close deals.",
    category: "Selling",
  ...
  },
  {
    ...
    answer:
      "Commissions are transferred to your bank account after a successful deal.",
    category: "Commissions",
  ...
  // Subscription Plans
  {
    ...
    answer:
      "We offer $19.99, $49.99, and $99.99 monthly plans with different benefits.",
  ...
  },
  {
    ...
    answer:
      "You get 3 buyer leads, 10 seller leads, 1000 in-system calls, and more.",
    category: "Subscription",
  ...
  },
  {
    ...
    answer:
      "You get 5 buyer leads, 1 hot buyer lead, 25 seller leads, and more.",
    category: "Subscription",
  ...
  },
  {
    ...
    answer:
      "You get 10 buyer leads, 2 hot buyer leads, unlimited calls, and more.",
    category: "Subscription",
  ...
  // Support
  {
    ...
    answer:
      "We provide 24/7 support via chat, email, and phone. Our dedicated team is always ready to assist you with any questions or concerns about the platform, properties, or sales processes.",
    category: "Support",
  ...
  },
  {
    ...
    answer:
      "You can email info@e-broker.world or use the chatbot on our website.",
    category: "Support",
  ...
  // Dubai Market
  {
    ...
    answer:
      "Through E Broker, you can sell various property types in Dubai including luxury apartments, villas, townhouses, office spaces, and retail units in prime locations across the emirate.",
    category: "Properties",
  ...
  },
  {
    ...
    answer:
      "Dubai's real estate market is known for its high returns, tax benefits, and international appeal. The market has shown consistent growth and attracts investors from around the world, making it an excellent opportunity for brokers.",
    category: "Market",
  ...
  },
  {
    ...
    answer:
      "Yes, we work with international clients! Our platform is designed to help property professionals worldwide connect with Dubai's real estate market. We provide all the tools and support needed to sell remotely.",
    category: "Clients",
...
const ChatPopup = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth >= 1024) {
        // LG devices (Large devices: >= 1024px)
        setIsOpen(true);
      } else {
  ...
  const findAnswer = (
    ...
    if (!normalizedInput) {
      return {
        answer:
          "Is there something specific about E Broker you'd like to know? You can ask about our membership, training, commissions, or support.",
        relatedQuestions: [
          "What is E Broker?",
    ...
    if (
      ...
      return {
        answer:
          "Thank you for chatting with us! Feel free to reach out anytime you have questions about E Broker. Have a great day!",
        relatedQuestions: [],
      };
    }
    ...
    if (
      ...
      normalizedInput.includes("where are you")
    ) {
      return {
        answer:
          "Our office is located at: Office 21-41, Conrad Business Tower, SZR, Dubai, United Arab Emirates.",
        relatedQuestions: [
          ...
          "Do I need to be in Dubai to sell properties?",
        ],
      };
    }

    if (
      normalizedInput.includes("time") ||
      normalizedInput.includes("long") ||
      normalizedInput.includes("duration")
    ) {
      return {
        answer:
          "The training program typically takes 2-4 weeks to complete, depending on your pace. Once certified, you can start selling properties immediately. Most of our members close their first deal within 1-3 months of joining.",
        relatedQuestions: [
          "What topics are covered in the courses?",
          "How do I start selling properties?",
    ...
    if (
      ...
      return {
        answer:
          "We accept various payment methods including credit/debit cards, bank transfers, and PayPal. All transactions are secure and processed promptly.",
        relatedQuestions: [
          "How much does membership cost?",
    ...
    return {
      answer:
        "I don't have specific information about that. Would you like to know about our membership, training programs, commission structure, or available properties?",
      relatedQuestions: [
        "What is E Broker?",
        "How does E Broker work?",
  ...
  return (
    <>
      ...
      >
        {isOpen ? "Close Chat" : "24/7 Chat Support"}
      </button>
        ...
        <div className="fixed bottom-16 z-20 right-0 md:right-4 w-65 md:w-96 bg-[#091650] text-white border border-gray-300 rounded-lg shadow-lg overflow-hidden">
          <div className="p-3 bg-white text-[#091650] font-bold text-center relative">
            ...
            <div className="text-xs font-normal mt-1">
              Ask me anything about E Broker!
            </div>
          </div>
